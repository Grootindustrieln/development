...
function positionTemplate() {
	...
	if(w < 1600){
		...
		c = b / 2;
		d = c + 215;
		$('#holder').css('margin-left', d).css('width','950px');
...
function openPopup() {
	...
	else { $tmp.append('<input type="button" value="'+btnFalse+'" id="'+btnFalseId+'" class="btnFalse semi_bold" style="right: 0px;" onclick="closePopup();">') }
