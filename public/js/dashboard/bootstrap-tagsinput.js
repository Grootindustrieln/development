(function ($) {
  ...
  TagsInput.prototype = {
    ...
    build: function(options) {
      ...
      if (self.options.addOnBlur && self.options.freeInput || true) {
          self.$input.on('focusout blur', $.proxy(function(event) {
          //HACK: only process on focusout when no typeahead opened, to
          //       avoid adding the typeahead text as tag
          //if ($('.tt-suggestion', self.$container).length === 0) {
          var topSuggestionDatum;
          topSuggestionDatum = $('.tt-suggestions')[0];
          if (topSuggestionDatum) {
            self.add(topSuggestionDatum.firstChild.firstChild.innerHTML);
          } else {
    ...
    /**
     * Resets the size of the input to the minimum
     */
